...
export default function Header() {
  ...
  const navItems = [
    ...
    { label: "Diensten", href: "/services", icon: Scissors },
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-200 transition">
        ...
        {menuOpen && (
          <div className="md:hidden px-4 pt-2 pb-4">
            <div className="mobile-menu animate-fadeInScale bg-white/60 backdrop-blur-md border border-gray-100 rounded-lg shadow-sm p-3 space-y-1 text-sm font-medium text-gray-800 tracking-wide">
